...
- 2026-07-06: Sikkerhet — koordinert bump av FastAPI-stacken for gjenoppståtte OSV HIGH-funn (issue #63): `python-multipart` 0.0.21→0.0.32, `starlette` 0.49.1→1.3.1 og `fastapi` 0.121.0→0.136.3 (sistnevnte nødvendig for å slippe starlette≥1.0 gjennom; matcher geoloops prod-verifiserte stack). Fikser bl.a. GHSA-5rvq-cxj2-64vf, GHSA-wp53-j4wj-2cfg, GHSA-82w8-qh3p-5jfq, GHSA-wqp7-x3pw-xc5r og PYSEC-2026-161/248/249. `web/requirements.lock` regenerert; `pip-audit` bekrefter 0 kjente sårbarheter, eksisterende test-suite grønn.
